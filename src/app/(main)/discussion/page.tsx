...
const forumCategories = [
  {
    ...
    color: "#007BFF",
    description:
      "Get help learning new skills and overcome learning challenges",
  },
  {
        ...
        >
          ...
          <Button
            ...
            sx={{
              mt: 2,
              borderColor:
                selectedCategory === "all" ? "primary.main" : "divider",
              color:
                selectedCategory === "all" ? "primary.main" : "text.secondary",
            }}
          >
            View All Categories
          </Button>
              ...
              >
                ...
                >
                  <Box sx={{ display: "flex", gap: 2 }}>
                    <Avatar
                      sx={{
                        bgcolor: getCategoryColor(thread.category),
                        width: 48,
                        height: 48,
                      }}
                    >
        ...
        >
          ...
          <DialogActions sx={{ p: 3 }}>
            ...
            <Button
              ...
              disabled={
                !newThread.title || !newThread.content || !newThread.category
              }
              sx={{
                background: "linear-gradient(135deg, #007BFF 0%, #6A0DAD 100%)",
              }}
