...
const getRarityColor = (rarity: string) => {
  switch (rarity) {
    ...
    case 'epic': return '#6A0DAD';
    case 'legendary': return '#FF7A00';
    default: return '#666';
  }
};
    ...
    <Container maxWidth="lg" sx={{ py: 4 }}>
      ...
      >
        ...
        <Box sx={{ mb: 4, display: 'grid', gridTemplateColumns: { xs: 'repeat(2, 1fr)', md: 'repeat(4, 1fr)' }, gap: 2 }}>
          <Paper sx={{ p: 3, textAlign: 'center', borderRadius: 3, background: 'linear-gradient(135deg, #e3f2fd 0%, #bbdefb 100%)' }}>
          ...
          <Paper sx={{ p: 3, textAlign: 'center', borderRadius: 3, background: 'linear-gradient(135deg, #f3e5f5 0%, #e1bee7 100%)' }}>
          ...
          <Paper sx={{ p: 3, textAlign: 'center', borderRadius: 3, background: 'linear-gradient(135deg, #fff3e0 0%, #ffe0b2 100%)' }}>
          ...
          <Paper sx={{ p: 3, textAlign: 'center', borderRadius: 3, background: 'linear-gradient(135deg, #e8f5e8 0%, #c8e6c9 100%)' }}>
        ...
        <Paper sx={{ mb: 4, borderRadius: 3 }}>
          ...
          >
            <Tab label="Skills Progress" icon={<BarChart3 size={20} />} iconPosition="start" />
            <Tab label="Achievements" icon={<Trophy size={20} />} iconPosition="start" />
            <Tab label="Learning Goals" icon={<Target size={20} />} iconPosition="start" />
            <Tab label="Weekly Activity" icon={<Calendar size={20} />} iconPosition="start" />
          </Tabs>
                  ...
                  >
                    <Card
                      sx={{
                        ...
                        border: achievement.earned ? `2px solid ${getRarityColor(achievement.rarity)}` : '2px solid #ddd',
                        position: 'relative',
                        overflow: 'visible',
                      }}
                    >
              ...
              <Box sx={{ display: 'grid', gap: 3 }}>
                {learningGoals.map((goal, index) => (
                  <motion.div
                    ...
                    transition={{ duration: 0.6, delay: index * 0.1 }}
                  >
                    <Card sx={{ borderRadius: 3, opacity: goal.completed ? 0.8 : 1 }}>
                      <CardContent>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 2 }}>
                          <Box sx={{ flex: 1 }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1 }}>
                              ...
                              {goal.completed && <CheckCircle size={20} color="#28a745" />}
                            </Box>
                            <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
                              {goal.description}
                            </Typography>
                            <Chip label={goal.category} size="small" color="secondary" variant="outlined" />
                          </Box>
                    ...
                    >
                      <Paper
                        sx={{
                          ...
                          border: day.completed ? '2px solid #28a745' : '2px solid #FF7A00',
                        }}
                      >
                        <Typography variant="body2" fontWeight="bold" sx={{ mb: 1 }}>
                          {day.day}
                        </Typography>
                        <Typography variant="h6" fontWeight="bold" color={day.completed ? '#28a745' : '#FF7A00'}>
                          {day.hours}h
                        </Typography>
                        {day.completed && <CheckCircle size={16} color="#28a745" style={{ marginTop: '4px' }} />}
                      </Paper>
                    </motion.div>
                  ))}
                </Box>
                ...
                <Card sx={{ borderRadius: 3 }}>
                  <CardContent>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                      ...
                      <Box>
                        <Typography variant="h4" fontWeight="bold" color="#FF7A00">
                          5 days
                        </Typography>
                        <Typography variant="body2" color="text.secondary">
