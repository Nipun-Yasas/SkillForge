...
const RewardDashboard = () => {
  ...
  const [selectedReward, setSelectedReward] = useState<TeacherReward | null>(
    null
  );
  ...
  const getRewardIcon = (type: string) => {
    switch (type) {
      case "cash":
        return <AttachMoney sx={{ color: "#4CAF50" }} />;
                ...
                >
                  ...
                  <Box sx={{ textAlign: "right" }}>
                    <Chip
                      label={reward.status}
                      color={
                        reward.status === "completed" ? "success" : "warning"
                      }
                      size="small"
                    />
                    <Typography
      ...
      >
        ...
        <DialogContent>
          ...
          {selectedReward?.type === "academic-credits" && (
            <TextField
              ...
              onChange={(e) =>
                setRedeemForm({ ...redeemForm, institution: e.target.value })
              }
              sx={{ mb: 2, mt: 1 }}
            />
          )}
        ...
        <DialogActions>
          ...
          <Button
            ...
            disabled={
              (selectedReward?.type === "cash" &&
                (!redeemForm.amount || !redeemForm.paymentMethod)) ||
              (selectedReward?.type === "academic-credits" &&
                !redeemForm.institution) ||
              (selectedReward?.type === "certificate" &&
                !redeemForm.certificateType)
            }
          >
            Redeem
          </Button>
